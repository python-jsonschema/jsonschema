...
class ErrorStrings:
    additional_properties_not_allowed = _("Additional properties are not allowed (%s %s unexpected)")
    additional_items_not_allowed = _("Additional items are not allowed (%s %s unexpected)")
    minimum_less_than = _("%r is less than the minimum of %r")
    minimum_less_than_or_equal = _("%r is less than or equal to the minimum of %r")
    maximum_more_than = _("%r is more than the maximum of %r")
    maximum_more_than_or_equal = _("%r is more than or equal to the maximum of %r")
    ...
    not_valid_in_any_schema = _("%r is not valid under any of the given schemas")
